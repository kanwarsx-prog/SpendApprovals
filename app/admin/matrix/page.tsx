                            ...
                            <CardContent className="p-0">
                                <table className="w-full text-sm text-left">
                                    ...
                                    <tbody className="divide-y divide-stone-100">
                                        ...
                                        <tr className="bg-white hover:bg-stone-50/50">
                                            <td className="px-6 py-4 text-stone-500">All</td>
                                            <td className="px-6 py-4 font-medium text-stone-900">£0+</td>
                                        ...
                                        {typeRules.map((rule) => (
                                            <tr key={rule.id} className="bg-white hover:bg-stone-50/50">
                                                <td className="px-6 py-4">
                                                    {rule.category ? (
